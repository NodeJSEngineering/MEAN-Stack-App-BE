...
- [business add](http://localhost:4000/business/add )
```javascript
{
    "person_name":"test",
    "business_name": "b test",
    "business_gst_number": 123
}
```
- [business get](http://localhost:4000/business)
- [business edit](http://localhost:4000/business/edit/65fbe958e3306e00b405fa4b)
- [business update](http://localhost:4000/business/update/65fbe958e3306e00b405fa4b)
- [business delete](http://localhost:4000/business/delete/65fbe958e3306e00b405fa4b)
- [business delete](http://localhost:4000/business/delete/65fbe958e3306e00b405fa4b)

- Add through html form
- [add business](http://localhost:4000/business/addbusiness)

- [POST addOwner](http://localhost:4000/owner/addOwner/)
```javascript
{
    "name":"p name",
    "phone": 124
...
```
- [GET Owner](http://localhost:4000/owner/)
- [GET Owner through Id](http://localhost:4000/owner/661bf49d5a5601030409e53b)
- [PATCH Owner through Id](http://localhost:4000/owner/661bf49d5a5601030409e53b)

- 1 Owner can have multiple businesses
- [POST Linking business and owner](http://localhost:4000/business/addbusiness/{OWNERID}/owner)
```javascript
{
    "person_name":"test",
    "business_name": "b test",
...
```
- Now If you see business response it will return this
```javascript
{
        "_id": "661bf82a0a3d4942140d053b",
        "person_name": "test n",
        "business_name": "b test n",
        "_ownerId": "661bf49d5a5601030409e53b",
        "__v": 0
    }
```

- [DELETE owner](http://localhost:4000/owner/{ownerid})
- [GET Page Pattern Match](http://localhost:4000/business/abcd)
- [DELETE test request](http://localhost:4000/business/del_user)
